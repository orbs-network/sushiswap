...
> = {
  ...
  [ChainId.KYOTO]: {
    client: createPublicClient(extractorClientConfig(ChainId.KYOTO)),
    factoriesV2: [sushiswapV2Factory(ChainId.KYOTO)],
    factoriesV3: [sushiswapV3Factory(ChainId.KYOTO)],
    tickHelperContractV3: SUSHISWAP_V3_TICK_LENS[ChainId.KYOTO] as Address,
    tickHelperContractAlgebra:
      '0x0000000000000000000000000000000000000000' as Address,
    cacheDir: './cache',
    logDepth: 50,
