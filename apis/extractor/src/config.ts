...
export type EnabledExtractorChainId = keyof typeof EXTRACTOR_CONFIG

export const isEnabledExtractorChainId = (
  chainId: number,
): chainId is EnabledExtractorChainId =>
  chainId in EXTRACTOR_CONFIG