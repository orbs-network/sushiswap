...
> = {
  ...
  [ChainId.KYOTO]: '0x46B3fDF7b5CDe91Ac049936bF0bDb12c5d22202e',
} as const
...
> = {
  ...
  [ChainId.KYOTO]: POOL_INIT_CODE_HASH,
} as const
...
> = {
  ...
  [ChainId.KYOTO]: '0x0389879e0156033202C44BF784ac18fC02edeE4f',
} as const
...
export const SUSHISWAP_V3_TICK_LENS: Record<SushiSwapV3ChainId, `0x${string}`> =
  {
    ...
    [ChainId.KYOTO]: '0x33d91116e0370970444B0281AB117e161fEbFcdD',
  } as const
